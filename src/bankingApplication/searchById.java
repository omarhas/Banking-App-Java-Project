...
public class searchById extends JPanel {
	private JTextField idField;
	private JTable table;
	public void resultToTableModel(Client client, JTable table) throws SQLException {
	...
	public searchById(Agent agent) {
		...
		idField.setBounds(118, 17, 205, 19);
		panel.add(idField);
		...
		searchBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					Client chosenOne = agent.getClient(Integer.parseInt(idField.getText()));
					System.out.print(chosenOne.getEmail());
					resultToTableModel(chosenOne, table);			            
				} catch (Exception e1) {
